...
const TESTIMONIALS = [
  {
    ...
    location: "Lahore",
    category: "Retail",
    text:     "We've been buying Apple stock from Horizon Tech for 4 years. Next-day delivery every time, full warranty docs with every unit. Never had a counterfeit issue — not once.",
    rating:   5,
    initials: "UT",
    color:    "#C8A96E",
  },
  ...
  },
  {
    ...
    location: "Faisalabad",
    category: "Retail",
    text:     "Nothing Phone 3a stock before any other supplier in Faisalabad. CMF earbuds sell out within days. Horizon Tech is our go-to for the Nothing lineup.",
    rating:   5,
    initials: "BC",
    color:    "#25D166",
  },
  ...
  },
  {
    ...
    location: "Lahore",
    category: "Corporate",
    text:     "Horizon Tech gave us iPhone 16 launch-day allocation. No other distributor could offer that. We sold out in 3 days. The relationship is worth every PKR.",
    rating:   5,
    initials: "HS",
    color:    "#EF4444",
  },
  {
    ...
    location: "Lahore",
    category: "Corporate",
    text:     "Government procurement demands complete documentation. Horizon Tech provided every certificate and compliance doc we needed. Completely transparent process.",
    rating:   5,
    initials: "TM",
    color:    "#3B82F6",
  },
